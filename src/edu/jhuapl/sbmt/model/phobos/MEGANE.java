...
//    public static double[] getOTESBandCenters() { return bandCenters; }
    ...
    public Spectrum getSpectrumInstance(String filename,
            ...
            throws IOException
    {
        return new MEGANESpectrum(filename, (SpectrumInstrumentMetadataIO)searchSpec, smallBodyModel.getBoundingBoxDiagonalLength(), this);
    }
