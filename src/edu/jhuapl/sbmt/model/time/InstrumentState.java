...
public class InstrumentState {
	...
	public static InstrumentState addInstrumentState(Vector<StateFileData> fbVec, double t, double scanAngle, double ifov, int imageNumber, int frameNumber, InstrumentState lastState)
	{
		...
		V3 pos = StateFileData.interpolateSpacecraftPosition(fbVec, t);
		V3 sunPos = StateFileData.interpolateSunPosition(fbVec, t);

		//velocity calculation (RD)
		V3 posp=StateFileData.interpolateSpacecraftPosition(fbVec, t + 0.5);
		V3 posm=StateFileData.interpolateSpacecraftPosition(fbVec, t - 0.5);
		...
		StateFileData.getAxes(fbVec, t, xAxis, yAxis, zAxis);
		st.xAxis.copy(xAxis);
		st.yAxis.copy(yAxis);
		st.zAxis.copy(zAxis);
	...
	public static String getStateString(Vector<StateFileData> fbVec, InstrumentState st, InstrumentState lastState)
	{
		String result = "";

		V3 sunPos = StateFileData.interpolateSunPosition(fbVec, st.t);
		UV sunUV = new UV();
