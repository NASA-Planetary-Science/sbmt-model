...
public class NisPlaneCurveHistogram extends RegularHistogram2D
{

    public NisPlaneCurveHistogram(int nPhaseBins, int nIntensityBins, double minIntensity, double maxIntensity)
    {
        super(LinearSpace.create(0, 90, nPhaseBins),LinearSpace.create(minIntensity, maxIntensity, nIntensityBins));
    }

    public NisPlaneCurveHistogram(int nPhaseBins, int nIntensityBins, double maxIntensity)
    {
    ...
    public void add(NisSample sample)
    {
        try
        {
            ...
            incrementCount(planeAngle,intensity);
...
//        NisPlaneCurveHistogram histogram=new NisPlaneCurveHistogram(360, 400, 50);
...
//        }
//
//        Path histogramFile=Paths.get("/Users/zimmemi1/Desktop/plane_angle_histogram.dat");
