...
//        {
//        	spacecraftPositionAdjusted = MathUtil.copy(image.spacecraftPositionOriginal);
//        	frustum1Adjusted = MathUtil.copy(image.frustum1Original);
//        	frustum2Adjusted = MathUtil.copy(image.frustum2Original);
//        	frustum3Adjusted = MathUtil.copy(image.frustum3Original);
//        	frustum4Adjusted = MathUtil.copy(image.frustum4Original);
//        	boresightDirectionAdjusted = MathUtil.copy(image.boresightDirectionOriginal);
//        	upVectorAdjusted = MathUtil.copy(image.upVectorOriginal);
//        	sunPositionAdjusted = MathUtil.copy(image.sunPositionOriginal);
//        }
//    }
//
...
//            for (int i = 0; i < 3; i++)
//            {
//            	surfacePoint[currentSlice][i] = image.spacecraftPositionOriginal[currentSlice][i] + image.boresightDirectionOriginal[currentSlice][i];
//            	spacecraftPositionAdjusted[currentSlice][i] = surfacePoint[currentSlice][i] - image.boresightDirectionOriginal[currentSlice][i] * zoomRatio;
//
...
//    {
//         Vector3D axis = new Vector3D(image.boresightDirectionOriginal[image.currentSlice]);
...
//        Vector3D spacecraftPositionVector = new Vector3D(image.spacecraftPositionOriginal[image.currentSlice]);
