 ...
 *
 */
public class GenerateSpectrumInputFile
{
    ...
    public static void main(String[] args) throws IOException {
      ...
      String filename = "/Users/osheacm1/Documents/SAA/SBMT/testSpectrum/sample_input.txt";
      FileWriter fw;
      try
      {
      ...
      String inputDir  = "/Users/osheacm1/Documents/SAA/SBMT/testSpectrum/infofiles/";
      ...
      for (File infoFile : infoFiles) {
          ...
          String spectrum = infoFile.getName();
...
//            System.out.println("emission angle: " + emissionAngle);
          ...
          if (tmp != null) {
              ...
              bw.write(thisFileName + " " + bbox[0] + " " + bbox[1] + " " + bbox[2] + " " + bbox[3] + " " + bbox[4] + " " + bbox[5] +" " + reader.getStartTime() + " " + reader.getStopTime()+", 0, 0, 0, 0\n");
          }
