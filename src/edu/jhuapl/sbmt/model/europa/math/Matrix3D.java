...
//import projection.IJ;
//import util.ArrayData;
//import util.GridData;
...
//    public void transform(GridData<V3> inGrid, GridData<IJ> outGrid)
//    {
//    	float x, y, z;
//    	float lxx = xx, lxy = xy, lxz = xz, lxo = xo;
//		float lyx = yx, lyy = yy, lyz = yz, lyo = yo;
//		//float lzx = zx, lzy = zy, lzz = zz, lzo = zo;
//
//		int w = inGrid.getWidth();
//		int h = inGrid.getHeight();
//
//		for (int row = 0; row < h; row++){
//			for (int col = 0; col < w; col++){
//				x = (float)inGrid.getElement(row, col).X1();
//				y = (float)inGrid.getElement(row, col).X2();
//				z = (float)inGrid.getElement(row, col).X3();
//				outGrid.setElement(row, col, new IJ((int)(x * lyx + y * lyy + z * lyz + lyo), (int) (x * lxx + y * lxy + z * lxz + lxo)));
//			}
//		}
//    }
